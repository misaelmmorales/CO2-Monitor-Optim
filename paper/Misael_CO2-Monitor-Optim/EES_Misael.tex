...
Following \citet{Chen2017328, Chen2018332} and \citet{Le2014505}, the VOI is quantified by the uncertainty reduction in the objective function. We denote the amount of uncertainty in cumulative CO$_2$ leakage distribution $P(M_c)$ as $U[P(M_c)]$, defined as:
...
\begin{figure} [H]
\centering
\includegraphics[width=15 cm]{Figure 4.jpg}
...
\begin{figure} [H]
\centering
\includegraphics[width=12 cm]{Figure 5.png}
